        ...
        'production' !== process.env.NODE_ENV &&
          (function () {
            ...
            function ee(e, r, n, o, a) {
              ...
              r))
                z.call(r, i) && !Z.hasOwnProperty(i) && (s[i] = r[i])
              if (e && e.defaultProps) {
              ...
              if (e._store && !e._store.validated && null == e.key) {
                ...
                if (!se[t]) {
                  ...
                  e &&
                    ...
                    e._owner !== te.current &&
                    (n =
                      ' It was passed a child from ' + k(e._owner.type) + '.'),
                    oe(e),
                    b(
      ...
      ? (i.exports = (function () {
          ...
          function u(e, r, t) {
            var o,
              ...
              u = null,
              l = null
            for (o in (void 0 !== t && (u = '' + t),
            void 0 !== r.key && (u = '' + r.key),
            void 0 !== r.ref && (l = r.ref),
            r))
              i.call(r, o) && !c.hasOwnProperty(o) && (a[o] = r[o])
            if (e && e.defaultProps)
        ...
        for (var e = [], n = 0; n < arguments.length; n++) {
          ...
          if (o) {
            ...
            if ('string' === a || 'number' === a) e.push(o)
              ...
              for (var s in o) r.call(o, s) && o[s] && e.push(s)
            }
          }
        }
        return e.join(' ')
